...
int main() {
    ...
    TFile* outFile = new TFile("mymain12_10k.root", "RECREATE");
    ...
    TH1F *muonZPt = new TH1F("Z_pt_sigma","Z -> mu;p_{T} (GeV/c);#frac{d#sigma}{dp_{T}} (mb/GeV/c)", 100, 0.0, 100.0);
    // TH1F *muonWEta = new TH1F("W_eta_sigma","W+ -> mu;#eta;#frac{d#sigma}{d#eta} (mb)", 100, -10.0, 10.0);

    // read events from POWHEG lhe output
    pythia.readString("Beams:frameType = 4");
    pythia.readString("Beams:LHEF = pwgevents_Z_10k.lhe");
    ...
    muonZPt->Scale(1/luminocity_hard, "width");
